...
/**
 * Interface NgramCountsInterface: interface to build the counts of n-grams from a training corpus 
 * (to be used by a language model).
 * 
 * Two methods are available to compute the counts of n-grams: 
 * either by parsing a corpus saved in a file, or by reading a NgramCountsInterface previously saved in a file. 
 * 
 * @author N. Hernandez and S. Quiniou (2017)
 *
 */
public interface NgramCountsInterface {
